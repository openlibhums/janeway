...
class TestTypesetting(TestCase):
    ...
    def test_can_manage_file(self):
        ...
        for user in users:
            ...
            self.assertTrue(
                func.called, "Security Error: Priviledged user cannot manage file."
            )
    ...
    def test_can_manage_file_bad_user(self):
        ...
        for user in users:
            ...
            self.assertFalse(
                func.called, "Security Error: Non priviledged user can manage file."
            )
    ...
    def test_archive_stage_hides_task(self):
        ...
        response = self.client.get(reverse("typesetting_assignments"))
        self.assertContains(
            response,
            "Active Article",
        )
    ...
    def test_archived_article_task_404s(self):
        ...
        response = self.client.get(
            reverse(
                ...
                kwargs={"assignment_id": self.archived_typesetting_task.pk},
            )
        )
        self.assertTrue(
    ...
    def test_active_article_task_200s(self):
        ...
        response = self.client.get(
            reverse(
                "typesetting_assignment",
                kwargs={"assignment_id": self.active_typesetting_task.pk},
            )
        )
        self.assertTrue(
            response.status_code,
