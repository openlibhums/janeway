    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "typesetter_note",
                    models.TextField(blank=True, verbose_name="Note to Editor"),
                ),
                (
                    "files_to_typeset",
                    models.ManyToManyField(
                        blank=True, related_name="files_to_typeset", to="core.File"
                    ),
                ),
                (
                    "galleys_created",
                    models.ManyToManyField(blank=True, to="core.Galley"),
                ),
                (
                    "manager",
                    models.ForeignKey(
