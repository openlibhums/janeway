...
class TestSecurity(TestCase):
    ...
    def test_article_edit_user_required_allows_access_to_production_articles(self):
        ...
        self.assertTrue(
            func.called,
            "article_edit_user_required decorator wrongly blocks access to articles that are "
            "in production",
        )

    def test_article_edit_user_required_allows_staff_access_to_production_articles(
        self,
    ):
        """
        ...
        self.assertTrue(
            func.called,
            "article_edit_user_required decorator wrongly blocks staff access to articles that"
            " are in production",
        )
    ...
    def test_article_edit_user_required_blocks_access_to_production_articles_if_no_user(
        self,
    ):
        """
