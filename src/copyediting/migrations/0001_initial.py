    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Select a decision that reflects your actions. If you've uploaded a new version of the file, select Corrections Required, if you're happy with the copyedit, select Accept.",
                        max_length=20,
                        null=True,
                ...
                (
                    "author_note",
                    models.TextField(
                        blank=True, null=True, verbose_name="Note to the Editor"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "copyedit_reopened_complete",
                    models.DateTimeField(
                        blank=True,
                        help_text="The date a reopen was complete",
                        null=True,
                    ),
                ),
