            ...
            for field in additional_fields:
                ...
                if answer:
                    try:
                        ...
                        field_answer = models.FieldAnswer.objects.create(
                            article=article, field=field, answer=answer
                        )
...
class AuthorForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "impactstory": forms.TextInput(
                attrs={"placeholder": _("ImpactStory profile")}
            ),
