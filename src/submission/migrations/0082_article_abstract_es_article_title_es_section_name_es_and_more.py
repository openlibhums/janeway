    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                help_text="During submission the author will be asked to upload a filethat is considered the main text of the article. You can usethis field to change the label for that file in submission.",
                max_length=255,
                null=True,
            ),
        ),
