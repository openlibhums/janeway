...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "comments_editor",
                    models.TextField(
                        blank=True, null=True, verbose_name="Comments to the Editor"
                    ),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        null=True,
                        related_name="data_figure_files",
                        to="core.File",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "section_editors",
                    models.ManyToManyField(
                        related_name="section_editors", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, null=True, related_name="manuscript_files", to="core.File"
            ),
        ),
        migrations.AddField(
            model_name="article",
