    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='submission.Section')),
            ],
            options={
