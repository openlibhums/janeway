...
class PublisherNote(AbstractLastModifiedModel):
    text = models.BleachField(max_length=4000, blank=False, null=False)
...
class Article(AbstractLastModifiedModel):
    ...
    competing_interests = BleachField(
        blank=True, null=True,
    ...
    comments_editor = BleachField(blank=True, null=True, verbose_name="Comments to the Editor",
    ...
    article_agreement = BleachField(default='')

    custom_how_to_cite = BleachField(
        blank=True, null=True,
...
class Licence(AbstractLastModifiedModel):
    ...
    text = BleachField(null=True, blank=True)
