...
urlpatterns = [
    ...
    re_path(
        r"^submission_items/$", views.submission_items, name="cms_submission_items"
    ),
    re_path(
        r"^submission_items/add/$",
        views.order_submission_items,
        name="cms_order_submission_items",
    ),
    re_path(
        r"^submission_items/order/$",
        views.edit_or_create_submission_item,
        name="cms_add_submission_item",
    ),
    re_path(
        r"^submission_items/(?P<item_id>\d+)/$",
        views.edit_or_create_submission_item,
