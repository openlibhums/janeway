...
urlpatterns = [
    ...
    re_path(
        r"^(?P<article_id>\d+)/assign_manager/(?P<user_id>\d+)/$",
    ...
    re_path(
        r"^(?P<article_id>\d+)/proofing_task/(?P<proofing_task_id>\d+)/notify/$",
        views.notify_proofreader,
        name="notify_proofreader",
    ),
    re_path(
        r"^(?P<article_id>\d+)/proofing_task/(?P<proofing_task_id>\d+)/edit/$",
        views.edit_proofing_assignment,
        name="edit_proofing_assignment",
    ),
    re_path(
        r"^(?P<article_id>\d+)/round/(?P<round_id>\d+)/edit/$",
        views.delete_proofing_round,
        name="delete_proofing_round",
    ),
    re_path(
        r"^(?P<article_id>\d+)/proofing_task/(?P<proofing_task_id>\d+)/review/$",
        views.do_proofing,
        name="review_proofing_task",
    ),
    re_path(
        r"^(?P<article_id>\d+)/proofing_task/(?P<proofing_task_id>\d+)/corrections/$",
        views.request_typesetting_changes,
        name="request_typesetting_changes",
    ),
    re_path(
        r"^(?P<article_id>\d+)/proofing_task/(?P<proofing_task_id>\d+)/corrections/(?P<typeset_task_id>\d+)/notify/$",
    ...
    re_path(
        r"^requests/(?P<proofing_task_id>\d+)/$", views.do_proofing, name="do_proofing"
    ),
    re_path(
    ...
    re_path(
        r"^requests/(?P<proofing_task_id>\d+)/file/(?P<file_id>\d+)/download/$",
    ...
    re_path(
        r"^requests/(?P<proofing_task_id>\d+)/preview/(?P<galley_id>\d+)/$",
        views.preview_galley,
        name="preview_galley",
    ),
    re_path(
        r"^requests/(?P<proofing_task_id>\d+)/galley/(?P<galley_id>\d+)/new_note/$",
        views.new_note,
        name="proofing_new_note",
    ),
    re_path(
        r"^requests/(?P<proofing_task_id>\d+)/galley/(?P<galley_id>\d+)/delete/$",
        views.delete_note,
    ...
    # Corrections
    re_path(
        r"^requests/corrections/$",
        views.correction_requests,
        name="proofing_correction_requests",
    ),
    re_path(
        r"^requests/corrections/(?P<typeset_task_id>\d+)/$",
