...
urlpatterns = [
    path(r'^submit/', include('submission.urls')),
    path(r'^', include(journal_urls)),
    path(r'^review/', include('review.urls')),
    path(r'^metrics/', include('metrics.urls')),
    path(r'^identifiers/', include('identifiers.urls')),
    path(r'^production/', include('production.urls')),
    path(r'^proofing/', include('proofing.urls')),
    path(r'^cms/', include('cms.urls')),
    path(r'^transform/', include('transform.urls')),
    path(r'^copyediting/', include('copyediting.urls')),
    path(r'^rss/', include('rss.urls')),
    path(r'^feed/', include('rss.urls')),
    path(r'^cron/', include('cron.urls')),
    path(r'^install/', include('install.urls')),
    path(r'^i18n/', include('django.conf.urls.i18n')),
    path(r'^api/', include('api.urls')),
    path(r'^api-auth/', include('rest_framework.urls', namespace='rest_framework')),
    path(r'^news/', include('comms.urls')),
    path(r'^reports/', include('reports.urls')),
    path(r'^repository/', include('repository.urls')),
    path(r'^utils/', include('utils.urls')),
    path(r'^workflow/', include('workflow.urls')),
    path(r'^discussion/', include('discussion.urls')),
...
if plugins:
    for plugin in plugins:
        try:
            urlpatterns += [
                re_path(r'^plugins/{0}/'.format(plugin.best_name(slug=True)), include('plugins.{0}.urls'.format(plugin.name))),
            ]
