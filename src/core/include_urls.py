...
urlpatterns = [
    ...
    re_path(r'^register/step/1/(?P<token>[\w-]+)/$', core_views.register, name='core_register_with_orcid'),
    ...
    re_path(r'^profile/add_orcid/(?P<token>[\w-]+)/$', core_views.profile_add_orcid, name='core_profile_add_orcid'),
