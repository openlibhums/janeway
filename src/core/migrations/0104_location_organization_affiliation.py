...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0103_typesetting_core_merge"),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        blank=True, help_text="City or place name", max_length=200
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=10,
                        validators=[core.models.validate_ror_id],
                        verbose_name="ROR ID",
                    ),
                ),
                (
                ...
                (
                    "locations",
                    models.ManyToManyField(blank=True, null=True, to="core.location"),
                ),
                (
                    "migration_id",
                    models.CharField(
                        blank=True,
                        max_length=200,
                        help_text="Temporary administrative id for use in Django migrations",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    models.CharField(max_length=1000, verbose_name="Organization name"),
                ),
                (
                    "language",
                    models.CharField(
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        to="core.organization",
                        help_text="This name is a custom label entered by the end user. Only exists in Janeway, independent of ROR.",
                    ),
                ),
                (
                    "label_for",
                    models.ForeignKey(
                        ...
                        related_name="labels",
                        to="core.organization",
                        help_text="This name is a preferred ROR-provided alternative, often in a different language from the ROR display name.",
                    ),
                ),
                (
                    "ror_display_for",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        max_length=300,
                        verbose_name="Title, position, or role",
                    ),
                ),
                (
                    "department",
                    models.CharField(
                        blank=True,
                        max_length=300,
                        verbose_name="Department, unit, or team",
                    ),
                ),
                (
                    "is_primary",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(("ror_id__exact", ""), _negated=True),
                fields=("ror_id",),
                name="filled_unique",
            ),
        ),
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    models.Q(
                        ...
                        ("frozen_author__isnull", True),
                        ("preprint_author__isnull", True),
                    ),
                    models.Q(
                        ("frozen_author__isnull", False),
                        ("account__isnull", True),
                        ("preprint_author__isnull", True),
                    ),
                    models.Q(
                        ("preprint_author__isnull", False),
                        ("account__isnull", True),
                        ("frozen_author__isnull", True),
                    ),
                    ("account__isnull", True),
