...
urlpatterns = [
    ...
    re_path(
        r"^article/(?P<identifier_type>{0})/(?P<identifier>[\w.-]+)/print/$" "".format(
    ...
    # Article patterns
    re_path(
        r"^article/(?P<identifier_type>{0})/(?P<identifier>[\w.-]+)/edit/$" "".format(
            NON_DOI_PIPE_SEPARATED_IDENTIFIERS
        ),
        views.edit_article,
        name="article_edit",
    ...
    re_path(
        r"^article/(?P<identifier_type>{0})/(?P<identifier>[\w.-]+)/$" "".format(
            NON_DOI_PIPE_SEPARATED_IDENTIFIERS
        ),
        views.article,
        name="article_view",
    ...
    re_path(
        r"^article/(?P<identifier_type>doi)/(?P<identifier>{0})/$" "".format(
            DOI_REGEX_PATTERN
        ),
        views.doi_redirect,
        name="doi_redirect",
    ...
    re_path(
        r"^article/(?P<identifier_type>doi)/(?P<identifier>{0})/print/$" "".format(
            DOI_REGEX_PATTERN
        ),
        views.doi_redirect,
