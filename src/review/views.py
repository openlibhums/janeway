...
# Editor-assignment view functions live in the editor_assignment app. They are
# re-exported here so existing imports (e.g. `from review.views import
# unassigned`) and URL patterns referencing `views.unassigned` continue to
# resolve. See bau#271.
from editor_assignment.views import (  # noqa: F401
    assign_editor,
