        ...
        with codecs.open(
            ...
            for item in default_data:
                if item["group"].get("name") == "email":
                    ...
                    item["setting"].get("type") == "rich-text"
                    or item["setting"].get("type") == "char"
                    or item["setting"].get("type") == "text"
                    or item["setting"].get("type") == "json"
                ):
                    item["setting"]["is_translatable"] = True
                else:
            ...
            write_path = os.path.join(
                settings.BASE_DIR, "utils/install/journal_defaults.json"
            )
