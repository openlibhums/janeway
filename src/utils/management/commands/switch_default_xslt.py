...
class Command(BaseCommand):
    """Switches a journal or journal's default XSLT to the provided file."""

    help = "Switches a journal or journal's default XSLT to the provided " \
           "file. Provide 'all' as journal code to apply to all journals."
    ...
    def handle(self, *args, **options):
        ...
        for journal in journals:
            print(f"[Setting XSLT for {journal.name}]")
            journal.xsl = xslt_file
            journal.save()
        print('[Complete]')
