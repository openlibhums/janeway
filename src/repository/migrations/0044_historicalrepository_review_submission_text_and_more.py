    ...
    operations = [
        migrations.AddField(
            ...
            field=core.model_utils.JanewayBleachField(
                blank=True,
                default="<p>Please review your submission carefully. Make any necessary changes to ensure that all information is accurate and complete.</p><p>When you are satisfied with your review click the button below to finalize your submission.</p>",
