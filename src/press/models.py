...
class Press(AbstractSiteModel):
    ...
    password_reset_text = JanewayBleachField(
        blank=True, null=True, default=press_text("reset")
    )
    registration_text = JanewayBleachField(
        blank=True, null=True, default=press_text("registration")
    )
