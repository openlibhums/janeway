        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "typeset_task",
                    models.TextField(
                        blank=True, null=True, verbose_name="Typesetting Task"
                    ),
                ),
                (
                    "note_from_typesetter",
                    models.TextField(
                        blank=True, null=True, verbose_name="Note to Editor"
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="production.ProductionAssignment",
                    ),
                ),
                (
                    "files_for_typesetting",
                    models.ManyToManyField(
                        related_name="files_for_typesetting", to="core.File"
                    ),
                ),
                (
                    "galleys_loaded",
                    models.ManyToManyField(
                        related_name="galleys_loaded", to="core.File"
                    ),
                ),
                (
                    "typesetter",
