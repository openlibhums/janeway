...
they are generally located in [src/core/]{.title-ref}.
...
[settings.py]{.title-ref} file to override variables.

Local Settings
--------------

This file is usually created during the setup process and can be based
on the provided [example\_settings.py]{.title-ref} file.
...
-   
    ...
    :   -   Provides the configuration for Python\'s logger. We
            recommend following the steps described in the [Django
        ...
        -   By default, Janeway will log both to the console as well as
            to the file located at [logs/janeway.log]{.title-ref} and
            rotates the file every 50MB. For production systems, you may
            want to change the location and/or rotation strategy as per
