...
### What's Changed
  ...
  - Remove "Incomplete submissions" from repository manager by @alainna
    in <https://github.com/BirkbeckCTP/janeway/pull/3626>
  ...
  - \#3802 rework the clean theme's editorial page layout. by @ajrbyers
    in <https://github.com/BirkbeckCTP/janeway/pull/3803>
  ...
  - Fixes additional whitespace being added after italics and bold to
...
### What's Changed
  ...
  - Updated custom replyto and added a catch incase reply\_to is not a
...
### Changelog
  ...
  - 3015 editors can now send author copyedit review notifications if
    ...
    author reviews with an optioinal email notification. by @ajrbyers in
  ...
  - Removed status logic from manager\_review\_status\_change setting.
...
<span class="title-ref">ENABLE\_FULL\_TEXT\_SEARCH = True</span>

For installations running PostgreSQL, it is also recommended to enable
the following setting: <span class="title-ref">CORE\_FILETEXT\_MODEL =
...
<span class="title-ref">python src/manage.py generate\_robots</span> and
<span class="title-ref">python src/manage.py generate\_sitemaps</span>.
...
### What's Changed
  ...
  - Preprints: add repository.custom\_js to every page by @tingletech in
  ...
  - \#1893 only assign an owner if there isn't one already by @ajrbyers
    in <https://github.com/BirkbeckCTP/janeway/pull/1920>
  ...
  - \[preprint\] -- author rework -- more tolerance for missing values
    by @tingletech in <https://github.com/BirkbeckCTP/janeway/pull/2084>
  ...
  - check is\_published for View Article moderator page (preprint-merge)
    by @tingletech in <https://github.com/BirkbeckCTP/janeway/pull/2483>
  - Add DOI and Preprint DOI to Author\_Article template by @hardyoyo in
  ...
  - \[preprints\] use <span class="title-ref">first.full\_name</span>
    rather than <span class="title-ref">all.0.author.full\_name</span>
    by @tingletech in <https://github.com/BirkbeckCTP/janeway/pull/2578>
  ...
  - Add frozen\_biography and biography() to FrozenAuthor by @joemull in
...
metadata. The setting <span class="title-ref">USE\_I18N</span> must be
...
### Bugfixes
  ...
  - <span class="title-ref">edit\_settings\_group</span> has been
    refactored (<https://github.com/BirkbeckCTP/janeway/issues/1708>)
  ...
  - JATS output for \`\<underline\><span class="title-ref">:
    </span>\<span class="underline"\><span class="title-ref"> is now
    supported via \`common.css</span>
...
### Deprecations
  ...
  - <span class="title-ref">utils.setting\_handler.get\_requestless\_setting</span>
    has been marked as deprecated and will be removed in 1.5.
  - PluginSettings and PluginSettingValues are deprecated as of 1.4 -
    all settings are now stored in
    <span class="title-ref">core.Setting</span> and
    <span class="title-ref">core.SettingValue</span> a migration moved
...
### Bugfixes
  ...
  - Section editors are now authorised by the
    <span class="title-ref">article\_stage\_accepted\_or\_later\_or\_staff\_required</span>
    security decorator
...
### Emails
  ...
  - <span class="title-ref">send\_reviewer\_accepted\_or\_decline\_acknowledgements</span>
