...
Tyepset files](../nstatic/typesetting/article_files_download.png)
...
![](../nstatic/typesetting/awaiting_typeseter.png)
...
![](../nstatic/typesetting/review_typesetting.png)

  - As an editor or production manager we can now select one out 3
    choices
...
![](../nstatic/typesetting/assigning_proofreaders.gif)
...
![](../nstatic/typesetting/proofreading_review.png)
...
![](../nstatic/typesetting/request_corrections_button.png)
...
![](../nstatic/typesetting/corrections_notes_display.png)
...
![](../nstatic/typesetting/corrections_files.png)
...
![](../nstatic/typesetting/supp_files.gif)
...
![](../nstatic/typesetting/editor/typeset_files.png)

An XML typeset file with missing figure files.

### File Detail

![](../nstatic/typesetting/editor/file_details.png)
...
![](../nstatic/typesetting/editor/edit_typeset_file.png)
...
![](../nstatic/typesetting/editor/image_files.png)
