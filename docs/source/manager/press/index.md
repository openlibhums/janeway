...
![The Press Manager page](../../nstatic/press-manager.png){.screenshot}
...
theme](../../nstatic/footer-olh.png){.screenshot}

![A customised journal footer in the material
theme](../../nstatic/footer-material.png){.screenshot}

![A customised journal footer in the clean
theme](../../nstatic/footer-clean.png){.screenshot}
